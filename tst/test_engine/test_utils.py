...
class TestUtils:
    def test_get_object_from_config_creates_object_correctly_when_correct_dict_for_main(self):
        config = {
            "class": "tst.test_engine.test_utils.MainTestObject",
            "args": {
                "nested_object1": {
                    "class": "tst.test_engine.test_utils.NestedTestObject",
                    "args": {
                        "double_nested_object": {
                            "class": "tst.test_engine.test_utils.DoubleNestedTestObject",
                            "args": {
                                "test_str": "dasdas",
                                "test_int": 5
                            }
