...
class SSingleGateTransformedPropertyTest(ExampleTestBase):
    @property
...
class XSingleGateTransformedPropertyTest(ExampleTestBase):
    @property
    def circuit(self) -> QuantumCircuit:
        qc = QuantumCircuit(1)
        qc.x(0)
...
class HSingleGateTransformedPropertyTest(ExampleTestBase):
    @property
    def circuit(self) -> QuantumCircuit:
        qc = QuantumCircuit(1)
        qc.h(0)
