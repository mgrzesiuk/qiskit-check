...
def mutation_no_entanglement_quantum_teleportation() -> QuantumCircuit:
    qr = QuantumRegister(3, name="q")
    crz, crx = ClassicalRegister(1, name="crz"), ClassicalRegister(1, name="crx")
    teleportation_result = ClassicalRegister(1, name="teleportation_result")
    circuit = QuantumCircuit(qr, crz, crx, teleportation_result)
...
def mutation_no_post_update_quantum_teleportation() -> QuantumCircuit:
    qr = QuantumRegister(3, name="q")
    crz, crx = ClassicalRegister(1, name="crz"), ClassicalRegister(1, name="crx")
    teleportation_result = ClassicalRegister(1, name="teleportation_result")
    circuit = QuantumCircuit(qr, crz, crx, teleportation_result)
...
def mutation_no_middle_gates_quantum_teleportation() -> QuantumCircuit:
    qr = QuantumRegister(3, name="q")
    crz, crx = ClassicalRegister(1, name="crz"), ClassicalRegister(1, name="crx")
    teleportation_result = ClassicalRegister(1, name="teleportation_result")
    circuit = QuantumCircuit(qr, crz, crx, teleportation_result)
